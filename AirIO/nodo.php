        ...
        <div class="row">
            ...
            <div class="col-md-3" id="colCard" onclick="location.href='chartTemperatura.php'">
                ...
                if (strcmp($nodo, $var4) === 0) {
                    ...
                    $url_rest = "https://things.ubidots.com/api/v1.6/devices/$nodo/$var/values?token=[YourUbidotsToken]";
            ...
            <div class="col-md-3" id="colCard" onclick="location.href='chartHumedad.php'">
                ...
                if(strcmp($nodo,$var4)===0){
                    ...
                    $url_rest = "https://things.ubidots.com/api/v1.6/devices/$nodo/$var2/values?token=[YourUbidotsToken]";
            ...
            <div class="col-md-3" id="colCard" onclick="location.href='chartCO2.php'">
               ...
               if(strcmp($nodo,$var4)===0){
                ...
                $url_rest = "https://things.ubidots.com/api/v1.6/devices/$nodo/$var3/values?token=[YourUbidotsToken]";
